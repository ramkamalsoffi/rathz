...
const ScalableTeams = () => {
  return (
    <section className="py-12 md:py-24 bg-transparent border-y border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
        <div className="py-0 md:py-12">
          <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-zinc-600 mb-6 flex items-center justify-center gap-4">
          ...
          <p className="text-white font-bold tracking-[0.2em] uppercase text-xs mb-10">Perfect for Modern Businesses in India</p>
          <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed font-medium mb-16">
