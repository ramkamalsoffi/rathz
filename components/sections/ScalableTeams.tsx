...
const ScalableTeams = () => {
  ...
  return (
    <section className="py-24 md:py-32 bg-transparent border-y border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-20 space-y-6">
          ...
          <p className="text-lg md:text-2xl text-zinc-400 max-w-4xl mx-auto leading-relaxed font-medium">
             Whether You&apos;re a 10-Person Startup or a 500-Person Enterprise — Sprintly Adapts to You.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {industries.map((item, i) => (
            ...
            >
              ...
              <div className="w-14 h-14 rounded-2xl bg-zinc-900 border border-white/5 flex items-center justify-center mb-8 group-hover:bg-blue-600 group-hover:border-blue-500 transition-all duration-500">
        ...
        <div className="mt-24 text-center">
            <div className="inline-flex items-center gap-4 px-8 py-4 rounded-full glass border border-white/5 group hover:border-blue-500/20 transition-all">
                <span className="text-white font-bold tracking-tight">If you have a team, Sprintly is built for you.</span>
            </div>
        </div>
      </div>
    </section>
