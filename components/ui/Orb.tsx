...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    vec4 mainImage(vec2 fragCoord) {
      ...
      float canvasSize = min(iResolution.x, iResolution.y);
      vec2 uv = (fragCoord - center) / (canvasSize * size) * 2.0;
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: any) => {
      ...
      const uvX = ((x - centerX) / sizeLimit) * 2.0;
      const uvY = ((y - centerY) / sizeLimit) * 2.0;
